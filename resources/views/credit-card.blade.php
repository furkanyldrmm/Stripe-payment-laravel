...
<body>
@php
    $stripe_key = 'sk_test_51HtazaKuw1q3WCZyi2il60ukWrq0cNuICJ8fNDQaN11FmQh9fb6mkWrYyFG34dfLIbp68BCrzsobxMPd0sHEkIUd00U3rg7MtE';
@endphp
<style>
    body {
        margin: 0;
...
<div class="deneme" style="margin-top:10%;margin-bottom:10%">
   ...
   <div class="button">
       <button style="background: #03A9F4;width:100%;padding: 10px"                           data-secret="{{ $intent }}"
       >Pay</button>
   </div>
    </form>
    </div>
